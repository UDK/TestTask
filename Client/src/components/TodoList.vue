<template>
  <Card>
    <template #content>
      <TreeTable :value="nodes" selectionMode="checkbox" v-model:selectionKeys="selectionKeys" :paginator="true"
        :rows="10">
  ...
  <InputText v-model="newItemRootText" style="margin: 6px;" />
  <Button type="button" icon="pi pi-plus" style="margin: 6px;" @click="acceptNewItem()" />
</template>
